...
import authBg from '../assets/hero_banner.jpg';
...
const Login = () => {
  ...
  const linkBtn = "mt-4 text-vintage-gold hover:text-vintage-umber transition text-sm";
    ...
    <div className="flex min-h-screen bg-vintage-cream">
      <div className="w-full md:w-1/2 flex flex-col justify-center items-center p-6 md:p-12">
        {resetStep === 0 ? (
          <form onSubmit={handleLogin} className={formWrapper}>
            <h2 className="font-display text-3xl text-center mb-6 text-vintage-obsidian">Welcome Back</h2>
          ...
          <form onSubmit={handleSendOtp} className={formWrapper}>
            <h2 className="font-display text-3xl text-center mb-6 text-vintage-obsidian">Reset Password</h2>
            <div className="mb-6">
              <label className="block text-sm font-medium mb-2 text-vintage-umber">Email</label>
              <input
                type="email"
          ...
          <form onSubmit={handlePasswordReset} className={formWrapper}>
            <h2 className="font-display text-3xl text-center mb-6 text-vintage-obsidian">Reset Password</h2>
            <div className="mb-4">
              <label className="block text-sm font-medium mb-2 text-vintage-umber">OTP</label>
              <input
                type="text"
                value={resetOtp}
            ...
            <div className="mb-4">
              <label className="block text-sm font-medium mb-2 text-vintage-umber">New Password</label>
              <input
                type="password"
                value={newPassword}
            ...
            <div className="mb-6">
              <label className="block text-sm font-medium mb-2 text-vintage-umber">Confirm Password</label>
              <input
                type="password"
      ...
      <div className="hidden md:block w-1/2 relative overflow-hidden">
        ...
        <div className="absolute bottom-10 left-10 text-vintage-cream">
          ...
          <p className="text-lg opacity-90">Welcome back to The Vintage Drop</p>
        </div>
      </div>
    </div>
  );
